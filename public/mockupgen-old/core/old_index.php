...
<body>
	<div class="wrapper">
		<div id="LumiseDesign"  data-processing="true" data-msg="<?php echo $lumise->lang('Initializing'); ?>..">

				<div class="navbar-header">
					
					<br>
				<button onclick="window.history.back();"  class="btn btn-info btn-md" >Back to Product Details</button>
			</div>
	...
	<script src="<?php echo $lumise->apply_filters('editor/app-uncompressed.js', $lumise->cfg->assets_url.'assets/js/app-uncompressed.js?version='.LUMISE); ?>"></script>
	<?php 
