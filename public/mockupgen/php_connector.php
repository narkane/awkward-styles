...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => '/var/www/html/app/public/lumise/data/',
			"upload_url" => 'http://ec2-54-173-246-53.compute-1.amazonaws.com/lumise/data/',
            "admin_assets_url" => $url.'core/admin/assets/',
            "admin_url" => $url.'admin.php?',
            
			"database" => array(
                "host" => 'pod-dev.ctm88vmcvn4y.us-west-1.rds.amazonaws.com',
                "user" => 'haskopod',
                "pass" => 'HoskoP0D!9876',
                "name" => 'haskopod',
                "prefix" => 'art_'
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'/var/www/html/app/public/lumise/data/',
				'http://ec2-54-173-246-53.compute-1.amazonaws.com/lumise/data/',
				'pod-dev.ctm88vmcvn4y.us-west-1.rds.amazonaws.com',
                'haskopod',
                'HoskoP0D!9876',
                'lumise',
                'lumise_'
