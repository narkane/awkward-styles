	...
	public function field_upload($attr = array()){
		...
		?>
			<div class="img-preview">
				...
				<?php } ?>
				<input type="file" id="lumise-<?php echo $attr['name']; ?>-file-upload" accept=".png" data-file-select="design" data-file-preview="#lumise-<?php echo $attr['name']; ?>-preview" data-file-input="#lumise-<?php echo $attr['name']; ?>-input" />

				<input type="hidden" class="lumise-upload-helper-inp" accept=".png" name="<?php
					echo $attr['name'];
				?>" id="lumise-<?php
					echo $attr['name'];
