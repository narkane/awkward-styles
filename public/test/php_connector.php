...
class lumise_connector {
    ...
    public function __construct() {
        ...
        $this->config = array(
            ...
            "upload_path" => '/var/www/html/app/public/test/data/',
			"upload_url" => 'http://ec2-54-173-246-53.compute-1.amazonaws.com/test/data/',
	...
	public function update() {
		...
		if (!empty($connector_content)) {
			...
			$connector_content = str_replace(array(
				'/var/www/html/app/public/test/data/',
				'http://ec2-54-173-246-53.compute-1.amazonaws.com/test/data/',
