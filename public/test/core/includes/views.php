						...
						<div class="lumise-stage-settings lumise-product-design<?php
							...
							<div class="lumise-stage-body" data-is-mask="<?php echo $is_mask; ?>">
								...
								?>>
									...
									?>" data-url="<?php echo $url; ?>" data-source="<?php echo $source; ?>" class="lumise-stage-image" data-svg="<?php echo (strpos('https://demo.lumise.com/data/thumbnails/bag-thumb-thumbn.jpg', '.svg') !== false); ?>" />
