...
@yield('aimeos_styles')
    ...
    <link href="{{ asset('easycomplete/easy-autocomplete.min.css') }}" rel="stylesheet">
    <link href="{{ asset('easycomplete/easy-autocomplete.themes.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/theme.css') }}" rel="stylesheet">
    <link href="{{ asset('css/Custom.css') }}" rel="stylesheet">
     <script src="{{ asset('js/jquery.min.js') }}"></script>
    <script src="{{ asset('js/popper.min.js') }}"></script>
    <script src="{{ asset('js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('easycomplete/jquery.easy-autocomplete.min.js') }}"></script>
