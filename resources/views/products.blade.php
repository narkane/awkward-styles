...
<div class="container">
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url: "{{env('API_URL')}}api/product/getProductList?pageNumber=1&limit=50",
                                    ...
                                    <div class="col-3 item">
                                        <div class="product-grid">
                                            <div class="product-image">
                                                <a href="{{url('/')}}/product-details/${artProduct.properties.products[i].id}">
    ...
    function pagination(page) {
        console.log(page);
        $.ajax({
            url: "{{env('API_URL')}}api/product/getProductList?pageNumber="+page+"&limit=50",
            contentType: 'application/json',
            dataType: 'json',
            headers: {
                "Authorization": "Bearer " + '{{$token}}',
