...
namespace Aimeos\Admin\JQAdm\Artwork;

sprintf( 'artwork' ); // for translation
	...
	implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
	...
	public function search()
	{
		...
		{
			$error = array( 'artwork-item' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
		catch( \Exception $e )
		{
			$error = array( 'artwork-item' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
			$view->errors = $view->get( 'errors', [] ) + $error;
			$this->logException( $e );
		}
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/artwork/template-list';
		$default = 'artwork/list-standard.php';
	...
	public function getSubClient( $type, $name = null )
	{
		 ...
		 * @see admin/jqadm/log/decorators/global
		 */
		return $this->createSubClient( 'artwork/' . $type, $name );
	}
	...
	protected function getSubClientNames()
	{
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/artwork/standard/subparts', [] );
	}
	...
	protected function render( \Aimeos\MW\View\Iface $view )
	{
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/artwork/template-item';
		$default = 'artwork/item-standard.php';
