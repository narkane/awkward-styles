...
namespace Aimeos\Admin\JQAdm\Templates\TheTool;

sprintf( 'thetool' ); // for translation


/**
 * Default implementation of log JQAdm client.
 *
 * @package Admin
 * @subpackage JQAdm
 */
    ...
    implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
    ...
    public function search()
    {
        ...
        try
        {
            ...
            //$search->setSortations( [$search->sort( '-', 'art_work.artname')] );
        ...
        {
            $error = array( 'thetool-item' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
            $view->errors = $view->get( 'errors', [] ) + $error;
            $this->logException( $e );
        }
        catch( \Exception $e )
        {
            $error = array( 'thetool-item' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
            $view->errors = $view->get( 'errors', [] ) + $error;
            $this->logException( $e );
        }
         ...
         * to the thetool directory (usually in admin/jqadm/thetool).
         *
         * You can overwrite the template file configuration in extensions and
         * provide alternative thetool. These alternative thetool should be
         ...
         * @category Developer
         */
        $tplconf = 'admin/jqadm/thetool/template-list';
        $default = 'templates/thetool-standard.php';
    ...
    public function getSubClient( $type, $name = null )
    {
         ...
         * @see admin/jqadm/log/decorators/global
         */
        return $this->createSubClient( 'thetool/' . $type, $name );
    }
    ...
    {
        /** admin/jqadm/log/standard/subparts
         ...
         * @category Developer
         */
        return $this->getContext()->getConfig()->get( 'admin/jqadm/thetool/standard/subparts', [] );
    }
    ...
    protected function render( \Aimeos\MW\View\Iface $view )
    {
         ...
         * @category Developer
         */
        $tplconf = 'admin/jqadm/thetool/template-item';
        $default = 'thetool/thetool-standard.php';
