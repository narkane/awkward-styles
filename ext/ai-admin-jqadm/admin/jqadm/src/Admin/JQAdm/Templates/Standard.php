...
namespace Aimeos\Admin\JQAdm\Templates;

sprintf( 'templates' ); // for translation
    ...
    implements \Aimeos\Admin\JQAdm\Common\Admin\Factory\Iface
{
    ...
    public function search()
    {
        ...
        {
            $error = array( 'templates-item' => $context->getI18n()->dt( 'mshop', $e->getMessage() ) );
            $view->errors = $view->get( 'errors', [] ) + $error;
            $this->logException( $e );
        }
        catch( \Exception $e )
        {
            $error = array( 'templates-item' => $e->getMessage() . ', ' . $e->getFile() . ':' . $e->getLine() );
            $view->errors = $view->get( 'errors', [] ) + $error;
            $this->logException( $e );
        }
         ...
         * @category Developer
         */
        $tplconf = 'admin/jqadm/templates/template-list';
        $default = 'templates/list-standard.php';
    ...
    public function getSubClient( $type, $name = null )
    {
         ...
         * @see admin/jqadm/log/decorators/global
         */
        return $this->createSubClient( 'templates/' . $type, $name );
    }
    ...
    protected function getSubClientNames()
    {
         ...
         * @category Developer
         */
        return $this->getContext()->getConfig()->get( 'admin/jqadm/templates/standard/subparts', [] );
    }
    ...
    protected function render( \Aimeos\MW\View\Iface $view )
    {
         ...
         * @category Developer
         */
        $tplconf = 'admin/jqadm/templates/template-item';
        $default = 'templates/item-standard.php';
