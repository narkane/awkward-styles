...
<section class="aimeos catalog-detail" itemscope="" itemtype="http://schema.org/Product" data-jsonurl="<?= $enc->attr( $this->url( $optTarget, $optCntl, $optAction, [], [], $optConfig ) ); ?>">
			...
			<div class="col-sm-7">
				...
				<div >
					...
					<p >
						...
						<span class="text-peach OpenSans-Bold" itemprop="sku"><?= $enc->html( $this->detailProductItem->getCode() ); ?></span>
					</p>
	...
	<!-- <div class="mt-2">	<a type="button" class="btn btn-sm btn-info btn-lg"  href="/mockupgen/editor.php?product=2" >Customize</a>
</div> -->
  <p>
                    <!-- <a href="/mockupgen/editor.php?product=<?= $enc->attr( $this->detailProductItem->getId() ); ?>" class="Customize text-peach"><span class="icon-paint-brush"></span> <span class="OpenSans-Semibold"> Customize </span><span class="font-italic">Change Artwork or Add Text</span></a>
                </p> -->
				<p>
					<a href="/mockupgenerator/<?= $enc->attr( $this->detailProductItem->getId() ); ?>" class="Customize text-peach"><span class="icon-paint-brush"></span> <span class="OpenSans-Semibold"> Customize </span><span class="font-italic">Change Artwork or Add Text</span></a>
                </p>
				
				   <div class="product-price">
<h1><?php if( isset( $this->detailProductItem ) ) : ?>
...
<p>Plus Shipping</p>
				...
				<div class="cart-section">
                    <div class="quntity">
                        <a class="aplus" href="#" role="button">
						 ...
						 <input type="hidden" value="add"
								...
								/>
								<input type="number" class="quntity-input" <?= $disabled ?>
                    ...
                    <div class="cart-div">
                        <button class="btn btn-orange" type="submit" value="" <?= $disabled ?> >
								<span class="icon-shopping-cart"></span>	<?= $enc->html( $this->translate( 'client', ' Add to cart' ), $enc::TRUST ); ?>
								</button>
                    </div>
                    <div class="share-div">
			...
			<div class="col-sm-12">
				...
				<?php if( $this->detailProductItem->getType() === 'bundle'
					...
					<section >
						<h2 class="pb-3"><?= $this->translate( 'client', 'Bundled products' ); ?></h2>
						<?= $this->partial(
				...
				<div class="catalog-detail-additional">
					...
					<?php if( ( $textItems = $this->detailProductItem->getRefItems( 'text', 'long' ) ) !== [] ) : ?>
						<div class="additional-box">
							<h5 class="header description"><?= $enc->html( $this->translate( 'client', 'Description' ), $enc::TRUST ); ?></h5>
					...
					<?php if( count( $attrMap ) > 0 || count( $this->detailProductItem->getRefItems( 'attribute', null, 'default' ) ) > 0 ) : ?>
						<div class="additional-box">
							<h5 class="header attributes"><?= $enc->html( $this->translate( 'client', 'Characteristics' ), $enc::TRUST ); ?></h5>
					...
					<?php if( count( $propMap ) > 0 ) : ?>
						<div class="additional-box">
							<h5 class="header properties"><?= $enc->html( $this->translate( 'client', 'Properties' ), $enc::TRUST ); ?></h5>
					...
					<?php if( ( $mediaItems = $this->detailProductItem->getRefItems( 'media', null, 'download' ) ) !== [] ) : ?>
						<div class="additional-box">
							<h5 class="header downloads"><?= $enc->html( $this->translate( 'client', 'Downloads' ), $enc::TRUST ); ?></h5>
				...
				<?php if( ( $posItems = $this->detailProductItem->getRefItems( 'product', null, 'suggestion' ) ) !== []
					...
					<section >
						<h2 class="pb-3"><?= $this->translate( 'client', 'Get this designs on other products' ); ?></h2>
						<?= $this->partial(
							$this->config( 'client/html/common/partials/products', 'common/partials/products-standard.php' ),
							array( 'products' => $products, 'itemprop' => 'isRelatedTo' )
						); ?>
				...
				<?php if( ( $posItems = $this->detailProductItem->getRefItems( 'product', null, 'bought-together' ) ) !== []
					...
					<section>
						<h2 class="pb-3"><?= $this->translate( 'client', 'More designs by Marc Summers' ); ?></h2>
						<?= $this->partial(
							$this->config( 'client/html/common/partials/products', 'common/partials/products-standard.php' ),
							array( 'products' => $products, 'itemprop' => 'isRelatedTo' )
						); ?>
 ...
 <section class="Aboutdesigner">
            <h3>About the designer</h3>
            <div class="media">
                <img src="/images/designer-image.png" class="mr-3" class="img-fluid" alt="...">
                <div class="media-body">
                    <h5>Marc Summers</h5>
                    <strong>Sweden</strong>
                    <h4 class="mt-2 text-peach">Go to designer’s store</h4>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas dignissim ultrices arcu a tincidunt. Morbi feugiat aliquam urna, et dapibus velit egestas eu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas dignissim ultrices arcu a
        ...
        <section class="review-section">
            ...
            <ul class="list-unstyled">
                <li class="media">
                    <img src="/images/user-review-image.png" class="mr-3">
                    <div class="media-body">

                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas dignissim ultrices arcu a tincidunt. Morbi feugiat aliquam urna, et dapibus velit egestas eu. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas dignissim ultrices arcu a
                        tincidunt. Morbi feugiat aliquam urna, et dapibus velit egestas eu. <a href="#" class="text-peach">More</a>
                        <h5 class="mt-1 mb-0 text-peach font-italic">Christopher, Texas</h5>
                    </div>
                </li>
                <li class="media">
                    <img src="/images/user-review-image.png" class="mr-3" alt="...">
                    <div class="media-body">
