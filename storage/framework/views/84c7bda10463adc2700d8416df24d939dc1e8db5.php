...
<div class="container">
    ...
    <div class="pannel catalog-detail" itemscope="" itemtype="http://schema.org/Product"
        data-jsonurl="<?php echo e(url('/')); ?>/jsonapi">
            ...
            <div class="col-sm-5">
                ...
                <div class="catalog-detail-basket" data-reqstock="1" itemprop="offers" itemscope=""
                    ...
                    <form method="POST" action="/basket">
                        ...
                        <p id="mockgen-url">
                            <a href="/mockupgenerator/<?php echo e($product_id); ?>" class="Customize text-peach"><span
        ...
        <span class="icon-shopping-cart"></span>Add to cart</button>
            ...
            <section class="Aboutdesigner col-sm-12" id="artist-details">
                ...
                <div class="media">
                    <img src="<?php echo e(asset('images/designer-image.png')); ?>" class="mr-3" class="img-fluid" alt="...">
            ...
            <section class="review-section col-sm-12" id="artist-details-reply">
                ...
                <ul class="list-unstyled">
                    <li class="media">
                        <img src="<?php echo e(asset('images/user-review-image.png')); ?>" class="mr-3">
                        <div class="media-body">
                    ...
                    <li class="media">
                        <img src="<?php echo e(asset('images/user-review-image.png')); ?>" class="mr-3" alt="...">
                        <div class="media-body">
...
$(document).ready(function() {
    $.ajax({
        ...
        success: (result) => {
            if (result.token) {
                $.ajax({
                    url: "<?php echo e(env('API_URL')); ?>api/product/getProductSpecifics?productId=<?php echo e($product_id); ?>",
                    contentType: 'application/json',
                    dataType: 'json',
                    headers: {
                    ...
                    success: function(artProduct) {
                        ...
                        if(artProduct.properties.artworkProduct) {
                            ...
                            $.ajax({
                                url: "<?php echo e(env('API_URL')); ?>api/users/getUserDetailsById/"+artProduct.properties.artworkProduct.createdById,
                                contentType: 'application/json',
                                dataType: 'json',
                                headers: {
                                    "Authorization": "Bearer " +
                                ...
                                success: function(userData) {
                                    ...
                                    $("#artist-sfront").html(`<a href="<?php echo e(url('/')); ?>/artiststorefront/${artProduct.properties.artworkProduct.createdById}">Go to designer’s store</a>`);
                                    $("#artistNameHere").html(`<span class="name">Designed By: </span><span class="text-peach OpenSans-Bold product_artistname" itemprop="artistname"><a href="<?php echo e(url('/')); ?>/artiststorefront/${artProduct.properties.artworkProduct.createdById}">${userData.properties.firstName} ${userData.properties.lastName}</a></spam>`)
                            ...
                            $.ajax({
                                url: "<?php echo e(env('API_URL')); ?>api/artworkProduct/getAllArtProducts?pageNumber=1&limit=4",
                                contentType: 'application/json',
                                dataType: 'json',
                                headers: {
                                    "Authorization": "Bearer " +
                                                ...
                                                <div class="col-3 item">
                                                    <div class="product-grid">
                                                        <div class="product-image">
                                                            <a href="<?php echo e(url('/')); ?>/product-details/${otherProducts.properties[i].product.id}"><img src="${images.properties.full_url}"></a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h3 class="title"><a style="color:#362865" href="<?php echo e(url('/')); ?>/product-details/${otherProducts.properties[i].product.id}">${otherProducts.properties[i].product.label}</a></h3>
                                                            <div class="price">
                            ...
                            $.ajax({
                                url: "<?php echo e(env('API_URL')); ?>api/artworkProduct/getAllArtProductsByArtist?artistId="+artProduct.properties.artworkProduct.createdById+"&pageNumber=1&limit=4",
                                contentType: 'application/json',
                                dataType: 'json',
                                headers: {
                                    "Authorization": "Bearer " +
                                    ...
                                    for(let i=0; i<sameArtistProducts.properties.length;i++) {
                                        ...
                                        $('#sameArtistProducts').append(`
                                            <div class="col-3 item">
                                                <div class="product-grid">
                                                    <div class="product-image">
                                                        <a href="<?php echo e(url('/')); ?>/product-details/${sameArtistProducts.properties[i].product.id}"><img src="${sameArtistProducts.properties[i].artworkProduct.designedImage}"></a>
                                                    </div>
                                                    <div class="product-content">
                                                        <h3 class="title"><a style="color:#362865" href="<?php echo e(url('/')); ?>/product-details/${sameArtistProducts.properties[i].product.id}">${sameArtistProducts.properties[i].product.label}</a></h3>
                                                        <div class="price">
                            ...
                            pid = <?php echo e($product_id); ?>;
                            console.log("art-",artProduct)
                            $.ajax({
                                url: "<?php echo e(env('API_URL')); ?>api/product/getProductSpecifics?productId="+pid,
                                contentType: 'application/json',
                                dataType: 'json',
                                headers: {
                                    "Authorization": "Bearer " + result.token,
...
<script type="text/javascript" src="<?php echo e(url('/')); ?>/packages/aimeos/shop/themes/jquery-ui.custom.min.js"></script>
<script type="text/javascript" src="<?php echo e(url('/')); ?>/packages/aimeos/shop/themes/aimeos.js"></script>
<script type="text/javascript" src="<?php echo e(url('/')); ?>/packages/aimeos/shop/themes/elegance/aimeos.js"></script>

<script type="text/javascript" src="<?php echo e(url('/')); ?>/packages/aimeos/shop/themes/aimeos-detail.js"></script>
