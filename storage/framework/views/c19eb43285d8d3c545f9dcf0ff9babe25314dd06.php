<?php $__env->startSection('content'); ?>
    ...
    <style>
        .men-bg {
            background-image: url('<?php echo e(asset('images/product-image-m.jpg')); ?>');
            height: 600px;
        ...
        .women-bg {
            background-image: url('<?php echo e(asset('images/product-image-w2.jpg')); ?>');
            height: 600px;
            background-size: cover;
            background-blend-mode: luminosity;
        ...
        .boys-bg,
        .girls-bg{
            background-image: url('<?php echo e(asset('images/product-image-boys.jpg')); ?>');
        ...
        .girls-bg{
            background-image: url('<?php echo e(asseT('images/product-image-girls.jpg')); ?>');
        }
        .other-bg {
            background-image: url('<?php echo e(asset('images/product-image-other.jpg')); ?>');
            height: 350px;
            background-size: cover;
