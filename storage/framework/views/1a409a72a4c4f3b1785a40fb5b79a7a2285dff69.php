...
<head>
  ...
  <link href="<?php echo e(asset('mockupgen_assets/css/theme.css')); ?>" rel="stylesheet">
  <link rel="stylesheet" href="<?php echo e(asset('mockupgen_assets/css/markup-generator.css')); ?>">
  <script defer src="<?php echo e(asset('mockupgen_assets/js/html2canvas.js')); ?>"></script>
  <script defer src="<?php echo e(asset('mockupgen_assets/js/art_canvas.js')); ?>"></script>
  <script defer src="<?php echo e(asset('mockupgen_assets/js/markupimageupload.min.js')); ?>"></script>
                        ...
                        <div id="GetPrice-div" class="GetPrice-div pull-bottom-top ">
                            ...
                            <div class="markup-bulk-section pannel">
                                ...
                                <div class="markup-pricebreakup-section pannel pull-right-left">
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <img class="img-fluid" src="<?php echo e(url('/')); ?>/mockupgen_assets/images/markup-images/football.png" alt="" width='30' height='45'>
                                        </div>
                                        <div class="col-6">
                                            ABC
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-2">
                                            <img class="img-fluid" src="<?php echo e(url('/')); ?>/mockupgen_assets/images/markup-images/football.png" alt="">
                                        </div>
                                        <div class="col-7">
                                            Football
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-2">
                                            <img class="img-fluid" src="<?php echo e(url('/')); ?>/mockupgen_assets/images/markup-images/text.png" alt="">
                                        </div>
                                        <div class="col-7">
                                            Sample Text
                                        </div>
                                            ...
                                            <div class="product-grid2">
                                                <div class="product-image2">
                                                    <a href="#" class="design-item-image">
                                                        <img class="pic-1" src="<?php echo e(asset('mockupgen_assets/images/products/product-5.png')); ?>">
                                                    </a>
                                                </div>
            ...
            if (result.token) {
                $.ajax({
                    ...
                    success: function(products) {
                        ...
                        $.ajax({
                            url: "<?php echo e(env('API_URL')); ?>api/product/getProductList",
                            contentType: 'application/json',
                            dataType: 'json',
                            headers: {
                                "Authorization": "Bearer " +
                                        ...
                                        success: function(images) {
                                            ...
                                            $("#products-list").append(`
                                                <div class="col-md-4">
                                                    <div class="product-grid2">
                                                        <div class="product-image2">
                                                            <a href="<?php echo e(url('/')); ?>/mockupgenerator/${products.properties.products[i].id}" class="design-item-image">
                                                                <img class="pic-1" src="${images.properties.full_url}">
                                                            </a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h3 class="title"><a href="<?php echo e(url('/')); ?>/mockupgenerator/${products.properties.products[i].id}">${products.properties.products[i].label}</a></h3>
                        ...
                        // $.ajax({
                        //     url: "<?php echo e(env('API_URL')); ?>api/master/getAllProductCategories",
                        //     contentType: 'application/json',
                        //     dataType: 'json',
                        //     headers: {
                        //         "Authorization": "Bearer " + result.token,
                        ...
                        $.ajax({
                            url: "<?php echo e(env('API_URL')); ?>api/artcategory/getAllArtCategories",
                            contentType: 'application/json',
                            dataType: 'json',
                            headers: {
                                "Authorization": "Bearer " + result.token,
                        ...
                        $.ajax({
                            url: "<?php echo e(env('API_URL')); ?>api/itemcategory/getAllItemCategories",
                            contentType: 'application/json',
                            dataType: 'json',
                            headers: {
                                "Authorization": "Bearer " + result.token,
