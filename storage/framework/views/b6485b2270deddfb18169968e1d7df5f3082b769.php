<?php $__env->startSection('content'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/jquery.miniColors.min.js')); ?>"></script>
    <style type="text/css">
        .footer {
            padding: 70px 0;
            margin-top: 70px;
            ...
            <div class="col-md-10">
                ...
                <div class="container shirt-block">
                    ...
                    <div id="shirtDiv" class="page"
                        ...
                        <img id="hoodieFacing" src="<?php echo e($images[0]->full_url); ?>"></img>
                    ...
                    <div class="clearfix">
                        <div class="btn-group inline pull-left" id="texteditor" style="display:none">
                            ...
                            <button id="text-italic" class="btn" data-original-title="Italic"><img
                                        src="<?php echo e(asset('images/mockup/font_italic.png')); ?>" height="" width=""></button>
