...
<section class="product-section" style="display:none">
  ...
  <script type = "text/javascript"  src = "https://code.jquery.com/jquery-3.3.1.min.js">
         ...
         $(document).ready(function() {
                ...
                $.ajax({url: "<?php echo e(env('API_URL')); ?>token", contentType: 'application/json', dataType: 'json', type: 'POST',   data: JSON.stringify({ "privateKey": "password"}) , success: function(result){ 
                      ...
                      $.ajax({url: "<?php echo e(env('API_URL')); ?>api/product/getProductList", contentType: 'application/json', dataType: 'json', headers: {
                         ...
                         success: function(products){ console.log("-0---",products);
                            ...
                            if(products.operationCode == 200){
                             ...
                             $.ajax({url: "<?php echo e(env('API_URL')); ?>api/media/getById/"+image[0], contentType: 'application/json', dataType: 'json', headers: {
                            "Authorization":"Bearer "+result.token,
                            "Content-Type":"application/json"
   ...
   <div class="container">
        <section class="pt-4">
            <div class="row">
                <div class="col-12">
                    <img src="<?php echo e(asset('images/home/contest.jpg')); ?>" class="img-100 rounded" alt="">
                </div>
            </div>
        </section>
    </div>
