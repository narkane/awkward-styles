...
<div class="categories-banner">
    <img src="<?php echo e(asset('images/categories-defult-banner.jpg')); ?>" alt="">
</div>
...
<div class="collections-section">
    ...
    <div class="container">
        ...
        <div class="owl-carousel " id="collections-slider" style="display:block">
            <div class="item">
                <a href="#"> <img src="<?php echo e(asset('images/collections/category/Funny.png')); ?>" width="100%"></a>
                <h6>Funny</h6>
            </div>
            <div class="item active">
                <a href="#"><img src="<?php echo e(asset('images/collections/category/HomeDecor.png')); ?>" width="100%"></a>
                <h6>Home Decor</h6>
            </div>
            <div class="item">
                <a href="#"><img src="<?php echo e(asset('images/collections/category/Parties-Events.png')); ?>" width="100%"></a>
                <h6>Parties & Events</h6>
            </div>
            <div class="item">
                <a href="#"><img src="<?php echo e(asset('images/collections/category/Sports.png')); ?>" width="100%"></a>
                <h6>Sports</h6>
            </div>
            <div class="item">
                <a href="#"><img src="<?php echo e(asset('images/collections/category/Trending.png')); ?>" width="100%"></a>
                <h6>Trending</h6>
            </div>
            <div class="item">
                <a href="#"><img src="<?php echo e(asset('images/collections/category/Vintage.png')); ?>" width="100%"></a>
                <h6>Vintage</h6>
            </div>
            <div class="item">
                <a href="#"> <img src="<?php echo e(asset('images/collections/category/Funny.png')); ?>" width="100%"></a>
