            ...
            <div class="product row " data-id="116">
                ...
                <div class="col-sm-8 bg-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <?php $__currentLoopData = $media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div>
                                    <?php if(!is_null($img->thumbnail)): ?>
                                        <img class="thumbnails" src="<?php echo e($img->thumbnail); ?>"/>
                                    <?php else: ?>
                                        <img class="thumbnails" src="<?php echo e($img->full_url); ?>"
                        ...
                        <div class="col-sm-9 bg-white" id="previewHolder">
                            <div class="catalog-detail-image pt-5">
                                <div class="image-single" id="add-images" data-pswp="{bgOpacity: 0.75, shareButtons: false}">
                                    <img id="image-0" src="<?php echo e($media[0]->full_url); ?>" alt="<?php echo e($product[0]->label); ?>"/>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <p><?php echo e($product[0]->label); ?></p>
                            <p>
                ...
                <div class="col-sm-4 bg-white rounded">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div>
                                <h1 class="name product_name" itemprop="name"><?php echo e($product[0]->label); ?></h1>
                                <p id="artistNameHere"></p>
                                <p><span class="name">Article no.: </span><span class="text-peach OpenSans-Bold product_sku"
                                                                                itemprop="sku"><?php echo e($product[0]->sku); ?></span></p>
                            </div>
                            ...
                            <div class="catalog-detail-basket" data-reqstock="1" itemprop="offers" itemscope=""
                                ...
                                <form method="POST" action="/basket">
                                            ...
                                            <li class="select-item select size">
                                                ...
                                                <div class="select-value">
                                                    ...
                                                    <select class="form-control select-list" id="varient-size" name="">
                                                        ...
                                                        <?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($attr->attribute_label == 'size'): ?>
                                                                <option class="select-option" <?php if($attr->value == 'L'): ?> selected
                                                                        <?php endif; ?> value="<?php echo e($attr->code1); ?>">
                                    ...
                                    <p id="mockgen-url">
                                        <a href="/mockupgenerator/0/<?php echo e($product_id); ?>" class="Customize text-peach"><span
                                            ...
                                            <div class="price-list">
                                                <div class="articleitem price price-actual" data-prodid="116"
                                                    ...
                                                    <div class="price-item default" itemprop="priceSpecification" itemscope=""
                                                        ...
                                                        <h3 class="value product_price">$<?php echo e($product[0]->salePrice); ?></h3>
                                    ...
                                    <div class="cart-section">
                                        <div class="quntity">
                                            ...
                                            <input type="hidden" name="b_prod[0][prodid]" value="<?php echo e($product_id); ?>">
                            ...
                            <div class="catalog-actions">
                                ...
                                <a class="actions-button actions-button-pin"
                                   href="/detail/pin/add/<?php echo e($product_id); ?>/<?php echo e($product_id); ?>/Puma_Crewneck_Tshirt/1"
                                   title="Pin"></a>


                                <a class="actions-button actions-button-watch"
                                   href="/myaccount/watch/add/<?php echo e($product_id); ?>/<?php echo e($product_id); ?>/Puma_Crewneck_Tshirt/1"
                                   title="watch"></a>


                                <a class="actions-button actions-button-favorite"
                                   href="/myaccount/favorite/add/<?php echo e($product_id); ?>/<?php echo e($product_id); ?>/Puma_Crewneck_Tshirt/1"
                                   title="favorite"></a>
                        ...
                        <div class="col-12 pt-3">
                            <div class="border-top">
                                ...
                                <input type="text" class="form-control-lg w-100 border" placeholder="Affiliate Link"
                                       value="http://awkwardstyles.com/affiliate/<?php echo e($user_id); ?>" />
                ...
                <div class="col-sm-12 p-0">
                    <div class="catalog-detail-additional">
                        <div class="additional-box rounded" id="artist-details">
                            ...
                            <div class="content">
                                <img src="<?php echo e(asset('images/designer-image.png')); ?>" class="mr-3" class="img-fluid"
                                     alt="...">
                        ...
                        <div class="additional-box rounded" id="more-from-designer">
                            ...
                            <div class="content">
                                ...
                                <?php $__currentLoopData = $designerTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="d-inline">
                                        <img src="<?php echo e($temp->full_url); ?>" alt="AwkwardStyles" style="max-width:200px;max-height:200px;padding:10px;"/>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            ...
            $(".thumbnails").on('click', function (e) {
                ...
                $("#add-images").html('<img id="image-0" src="' + $(this).attr('src') + '" alt="<?php echo e($product[0]->label); ?>"/>');
            ...
            $(".select-entry-color label").on('click', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (images) {
                        $("#add-images").html('<img id="image-0" src="' + images.properties.full_url + '" alt="<?php echo e($product[0]->label); ?>"/><div id="imagePreview"></div>');
                        imagePreviewer();
                    }
                });
                e.preventDefault();
