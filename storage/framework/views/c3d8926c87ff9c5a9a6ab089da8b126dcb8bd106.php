...
<?php if(count($storefronts)>0): ?>
        ...
        <div class="artistprofile" style="background-image: url('<?php echo e(url($storefront->banner_image_path) ?  url($storefront->banner_image_path) :  url('/').'/images/artist-banner.png'); ?>');background-repeat: no-repeat; background-size: cover;">
            ...
            <h3 class="artistname"><?php echo e($storefront->name); ?></h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php if(count($owner_data)>0): ?><?php echo e($owner_data[0]->name); ?> <?php else: ?> Marc Summers <?php endif; ?></li>
            </ol>
        </nav>
        <div class="row">
            <div class="col-xl-9 col-lg-9">
                <div class="media mb-4">
                    <img src="<?php echo e(url('images/artist-defult.png')); ?>" class="img-fluid rounded-circle mr-3" alt="Generic placeholder image">
                    <div class="media-body">
                        <h4 class="mt-0">About <?php if(count($owner_data)>0): ?><?php echo e($owner_data[0]->name); ?> <?php else: ?> Marc Summers <?php endif; ?></h4>
