...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light shadow-sm  bg-light ">
                                ...
                                <li class="dropdown-submenu dropdown-submenu-toggle active">
                                    ...
                                    <ul class="dropdown-menu" style="display: block;">
                                        <li>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <a href="/mockupgenerator/112" class="nav-l3-title">T-Shirt</a>

                                                </div>
                                                <div class="col-md-3">
                                                    <a href="/mockupgenerator/88" class="nav-l3-title">Tank Top</a>
                                                </div>
                                                <div class="col-md-3">
                                                    <a href="/mockupgenerator/111" class="nav-l3-title">Hoodie</a>
                                                </div>
                                                <div class="col-md-3">
                                ...
                                <li class="dropdown-submenu dropdown-submenu-toggle">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <a href="/mockupgenerator/336" class="nav-l3-title">Bag</a>

                                                </div>
                                                <div class="col-md-3">
                                                    <a href="/mockupgenerator/684" class="nav-l3-title">Hat</a>
                                                </div>
        ...
        <div class="header-product-menu" id="header-product-menu">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="<?php echo e(url("/product/womens/")); ?>" title="Womens">Women</a>
                </li>
                <li class="nav-item">
